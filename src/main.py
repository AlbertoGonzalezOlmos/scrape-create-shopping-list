def main():
    ...
    from string_formatting import format_recipe_names_list_to_text, format_quantity_ingredients_listtext_to_listdictionary
    from llm_proxy import LlmProxy
    from language_processing import get_week_number, pipeline_get_grocery_list, pipeline_get_grocery_list_from_text
    ...
    # recipe_names_url_list, list_quantity_ingredients = scrape_recipe_names_ingredients(most_recent_week_url)
    ...
    output_recipe_names_path_name = (
        output_recipe_names_path + output_recipe_name
    )
    write_file(output_recipe_names_path_name, recipe_names_url_text)
    
    quantity_ingredient_listdict = format_quantity_ingredients_listtext_to_listdictionary(list_quantity_ingredients)
